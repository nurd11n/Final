...
from .views import (DriverSignUpView, UserSignUpView, DriverOnlyView,
                    UserOnlyView, ChangePasswordView, ActivationView, GiveCarViewSet)
...
urlpatterns = [
    ...
    path('driver/activate/<str:email>/<str:activation_code>/', ActivationView.as_view(), name='activate'),
    path('user/activate/<str:email>/<str:activation_code>/', ActivationView.as_view(), name='activate'),
